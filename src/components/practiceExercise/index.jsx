...
const PracticeExercise = ({instructions, renderExercise}) => {
	return (
		<div className='flex flex-col justify-between gap-4 p-5 my-5 bg-slate-100 rounded-xl practice-exercise'>
            ...
            <section>
                {renderExercise ? renderExercise() : renderExercise}
            </section>
            <div className='flex justify-around'>
                <button className=' border-black border-2 bg-black text-white px-6 py-3 rounded-lg'>Show me the answer</button>
